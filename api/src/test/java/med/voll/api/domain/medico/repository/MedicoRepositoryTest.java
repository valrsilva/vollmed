...
class MedicoRepositoryTest {
	...
	void testEscolherMedicoAleatorioLivreNaData() {
		...
		Medico medico = new Medico(null, "JOSÉ", "jose@email.com", "994067920", "123456", Especialidade.CARDIOLOGIA,
				endereco, true);
		Paciente paciente = new Paciente(null, "ARNALDO", "arnaldo@email.com", "911112222", "11111111111", endereco,
				true);

		cadastrarMedico(medico);
		cadastrarPaciente(paciente);

		Consulta consulta = new Consulta(null, medico, paciente, proximaSegundaAsDez);
		cadastrarConsulta(consulta);

		Medico escolherMedicoAleatorioLivreNaData = medicoRepository
				.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA, proximaSegundaAsDez);
